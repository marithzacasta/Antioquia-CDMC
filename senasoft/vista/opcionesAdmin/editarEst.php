...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://localhost/Antioquia-CDMC/apisenasoft/controlador/establecimiento.php?texto1='.$texto1);
...
<div class="edit2-est cont-est">
        <form class="form-edit" action="http://localhost/Antioquia-CDMC/apisenasoft/controlador/establecimiento.php" method="put">
            <h1>Editar</h1>
            <?php
            ...
            <form class="form-edit" action="http://localhost/Antioquia-CDMC/apisenasoft/controlador/establecimiento.php" method="DELETE">
                 <br><input type="submit" value="Eliminar" id="btn-edit2-mun" class="btn-edit">
                 <input  type="hidden" name="id" id="id" value="<?php echo $ver["idEstablecimiento"]; ?>">
                 <?php
            endforeach;
            ?>
             </form>
