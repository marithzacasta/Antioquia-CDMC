...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $nombreCategoria = $_POST["texto1"];
    $descripcion = $_POST["texto2"];

    $api_url = 'http://localhost/Antioquia-CDMC/apisenasoft/controlador/categoria.php';
    $data = array('texto1' => $nombreCategoria, 'texto2' => $descripcion);
...
<div class="create-cat">
        <form class="form-create" action="http://localhost/Antioquia-CDMC/apisenasoft/controlador/categoria.php" method="post">
            <h1>Registrar</h1>
            <input class="nombre" type="text" name="texto1" placeholder="Ingrese el nombre de la Categoría"><br>
